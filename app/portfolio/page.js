      ...
      <div className={styles.portfolioPageStyle}>
         ...
         <section className={`${styles.dropdownStyle}`}>
            <div className={`${styles.inputDropPadding}`}>
               <CustomDropdown title="Services" options={["Data", "It Development", "Network Security", "Cloud Service"]} />
            </div>
            <div className={`${styles.inputDropPadding}`}>
               <CustomDropdown title="Industry" options={["Hardware", "Software", "Systems Integrator"]} />
            </div>
            <div className={`${styles.inputDropPadding}`}>
               <CustomDropdown
                  title="Technology"
                  options={["Web Content", "Frontend", "Backend", "Mobile Development", "Artificial Intelligence", "DevOps & Cloud"]}
               />
            </div>
         </section>
