...
const ContactHeroBanner = ({ props }) => {
   ...
   return (
      <section className={`${styles.contactHeroBannerStyle} ${theme ? styles.contactHeroBannerDark : ""}`}>
         <div className={cn("primary-container", styles.globalRow)}>
            <TextRevel>
               <div className={styles.contentSection}>
                  <h1 className={cn(styles.title, "gradient-text")} dangerouslySetInnerHTML={{ __html: `${props?.title}` }}></h1>
               </div>
            </TextRevel>
         </div>
