...
return(
  <motion.div className={styles.cardSec} style={{scale}}>
          ...
          <div className={styles.cardContentStyle}>
            <div>
              <motion.h4 variants={opacity} animate={isInView ? "open" : "closed"} className={styles.projectBrand}>
            ...
            <motion.div variants={opacity} animate={isInView ? "open" : "closed"} className={styles.ProjectBtn}>
...
const Projects = () => {
  ...
  const projects=[{src:"/images/ICICI.png",summary:"Royal Enfield is a global brand since 1901, has a geographical presence in over 70 countries. The brand delivers consistent, omnichannel customer experiences, achieves scalability, diversifying into countries, and continents."},{src:"/images/project-re.png",summary:"Royal Enfield is a global brand since 1901, has a geographical presence in over 70 countries. The brand delivers consistent, omnichannel customer experiences, achieves scalability, diversifying into countries, and continents."},{src:"/images/Manipal.png",summary:"Royal Enfield is a global brand since 1901, has a geographical presence in over 70 countries. The brand delivers consistent, omnichannel customer experiences, achieves scalability, diversifying into countries, and continents."}]
