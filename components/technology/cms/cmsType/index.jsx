...
const CmsType = ({ props }) => {
   ...
   const typeCard = [
      {
         ...
         sbTitle: "Drupal",
         sbText: "We Provide A Humanized And Contextual Experience To Build An Exclusive Digital Experience.",
      },
      {
         imgUrl: "/images/wordpress.png",
         darkImgSrc: "/images/partners/shopify-dark.svg",
         sbTitle: "WordPress",
         sbText: "We Believe In Superior Frontend Development With The Combination Of JavaScript, HTML And CSS.",
      },
      {
         imgUrl: "/images/Shopify.svg",
         darkImgSrc: "/images/partners/shopify-dark.svg",
         sbTitle: "Shopify",
         sbText: "At TechChefz We Provide First-Class Artificial Intelligence And Machine Learning with Expertise.",
      },
      {
         imgUrl: "/images/strapi.png",
         darkImgSrc: "/images/partners/shopify-dark.svg",
         sbTitle: "Strapi",
         sbText: "We Facilitate Easy Cloud Migration And Deliver DevOps Automation And 24*7 Incident Management Services.",
      },
      {
         imgUrl: "/images/aem.svg",
         darkImgSrc: "/images/partners/shopify-dark.svg",
         sbTitle: "AEM",
         sbText: "We Have Expertise In Development Of Mobile Applications Using Native And Hybrid Technologies.",
      },
      {
         imgUrl: "/images/Shopify.svg",
         darkImgSrc: "/images/partners/shopify-dark.svg",
   ...
   return (
      <section className={`${styles.cmsTypeStyle} ${theme ? styles.cmsTypeDark : ""}`}>
         <div className={cn("primary-container")}>
            <TextRevel>
               <div className={styles.careerRow}>
                  ...
                  <h2 className={cn(styles.datingText, "gradient-text")} dangerouslySetInnerHTML={{ __html: `${props?.Description}` }}></h2>
               </div>
            </TextRevel>
         ...
         <LeftDrawer title={props?.Slider[index]?.Title} open={isOpen} onClose={() => setIsOpen(false)}>
            <div className={cn(styles.modalBody, theme ? styles.darkThemeStyle : "")}>
               ...
               <p className={styles.modalContent}>{props?.Slider[index]?.Description}</p>
