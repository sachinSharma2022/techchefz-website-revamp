    ...
    <section className={`${styles.PrivacyPolicyData}`}>
      <div className={styles.policyDivide}>
        ...
        <p className={styles.leadText}>
          ...
          number or other details to identify you and help you with your
          experience.
        </p>
      </div>
      <div className={styles.policyDivide}>
      ...
      <div className={styles.policyDivide}>
        ...
        <ul className={styles.customerList}>
          <p className={`${styles.leadText} ${styles.textSpace}`}>
            Our website is scanned on a regular basis for security loopholes and
      ...
      <div className={styles.policyDivide}>
        ...
        <ul className={styles.customerList}>
          <p className={`${styles.leadText} ${styles.textSpace}`}>
            ...
            Cookies are used to help us understand your preferences based on
            ...
            aggregate data about site traffic and interactions so that we can
            offer better Techchefz site experiences and tools in the future.
          </p>
          ...
          <li className={styles.list}>
            You do this through your browser (e.g. Chrome or Internet Explorer)
            settings. Each browser is a little different, so refer to your
