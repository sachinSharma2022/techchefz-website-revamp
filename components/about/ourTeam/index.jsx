        ...
        <div className={styles.teamModal}>
          ...
          <div className={styles.modalBottom}>
            <p className={styles.madalContent}>
              ...
              profound understanding of industry trends and unwavering
              commitment, he spearheads our strategic direction, driving
              innovation and growth. As our dedicated CTO, Mayank Maggon shapes
              our technological landscape. With a rich background in tech, he
              leads our teams in creating cutting-edge solutions, ensuring we
