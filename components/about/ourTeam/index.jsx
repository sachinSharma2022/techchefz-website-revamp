                     ...
                     <Tab.Group>
                        <div className={styles.ourTeamHead}>
                           ...
                           <Tab.List className={styles.tabWrapper}>
                              <Tab>{({ selected }) => <span className={selected ? styles.btnActive : styles.btnIn}>Directors</span>}</Tab>
                              <Tab>{({ selected }) => <span className={selected ? styles.btnActive : styles.btnInactive}>Executive Team</span>}</Tab>
                           </Tab.List>
                        </div>
                  ...
                  <div className={styles.teamModal}>
                     <div className={styles.modalTop}>
                        ...
                        <div className={styles.modalImg}>
                           <ImageCustom  src={"/images/img/team/profile1.png"} width={200} height={230} alt="profile" />
                        </div>
                     ...
                     <div className={styles.modalBottom}>
                        <p className={styles.madalContent}>
                           Our visionary CEO, brings dynamic leadership to Techchefz. With a profound understanding of industry trends and unwavering
                           commitment, he spearheads our strategic direction, driving innovation and growth. As our dedicated CTO, Mayank Maggon
                           shapes our technological landscape. With a rich background in tech, he leads our teams in creating cutting-edge solutions,
                           ensuring we stay at the forefront of industry advancements.
                        </p>
                        <p className={styles.teamMail}>
                           <Icons.mail width={24} height={24} className="me-2" /> mayankmaggon@techchefz.com
                        </p>

                        <h6>Let’s Get Connect</h6>
                        <div className={styles.modalIcons}>
                           <Icons.Linkdin className={styles.linkdinIcon} width={34} height={34} />
                           <Icons.twitter className={styles.twitter} width={34} height={34} />
                        </div>
                     </div>
                  </div>
               </div>
