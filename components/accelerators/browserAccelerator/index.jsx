...
const BrowserAccelerator = () => {
   ...
   const browserCardData = [
      {
         ...
         description: "Elevate your product accessibility with strategic inventory management & optimization, ensuring consistently meetin...",
      },
      {
   ...
   return (
      <section className={`${styles.browserAccelerator} ${theme ? styles.browserAcceleratorDark : ""}`}>
         <div className={cn("primary-container")}>
            <div className={styles.topSection}>
               <SearchInput />
               <CustomDropdown
                  title="Industry"
                  options={["Automobile", "It Development", "Network Security", "Cloud Service"]}
                  className={styles.grayInput}
               />
               <CustomDropdown
                  title="Technology"
                  options={["AEM", "It Development", "Network Security", "Cloud Service"]}
                  className={styles.grayInput}
               />
               <CustomDropdown
                  title="Sort By"
                  options={["Newest First", "It Development", "Network Security", "Cloud Service"]}
                  className={styles.grayInput}
               />
            </div>
